/* 
 * @Author: geekli 
 * @Date: 2020-12-15 19:38:16 
 * @LastEditTime: 2021-01-04 16:59:01
 * @LastEditors: your name
 * @Description: test2 in operate system 
 * @FilePath: /OS_Test/osTest/test2/test2.c
 */  
#include "stdio.h"  
//#include "conio.h"  
#include "stdlib.h"  
...
struct PCB_type neicun[20];int num=0,guaqi=0,bj,i,j,pid;/*定义相关参数变量*//*********************创建新进程*************************/void create()  
{    
    if(num>=20)   /*判断是否有存储空间*/  
        printf("\n 内存已满，请删除或挂起其他程序");  
    else{  
...
{    
    bj=0;  
    for(i=0;i<20;i++)if(neicun[i].state==1)   /*若进程状态设为1，表示在内存中，输出查看*/  
    {  
        printf("\n pid=%d",neicun[i].pid);  
...
void main()  
{  
    int xuhao,n=1,i;for(i=0;i<20;i++)  
